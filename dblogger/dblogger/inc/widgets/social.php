...
class Dblogger_Premium extends WP_Widget{
    ...
    function __construct() 
    {
        parent::__construct(
            ...
            esc_attr__( 'Dblogger-Sidebar social widget', 'dblogger' ), // Name
            array( 
		...
		function Dblogger_Premium_widget_scripts(){

		   wp_enqueue_media();

		  wp_enqueue_script( 'Dblogger_Premium_widget_scripts', get_template_directory_uri() . '/js/widget.js', false, '1.0', true );
...
<?php }?>
    ...
    public function form( $instance ) {
        ...
        ?>
         ...
         <p>
            <label for="<?php echo $this->get_field_id('social_title'); ?>"><?php esc_html_e( 'Social Title', 'dblogger' ); ?></label><br/>
         ...
         <p>
            <label for="<?php echo $this->get_field_id('facebook_url'); ?>"><?php esc_html_e( 'Facebook Url', 'dblogger' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('twitter_url'); ?>"><?php esc_html_e( 'Twitter Url', 'dblogger' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('google_url'); ?>"><?php esc_html_e( 'Google Url', 'dblogger' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('inst_title'); ?>"><?php esc_html_e( 'Instagram Title', 'dblogger' ); ?></label><br/>
         ...
         <p>
            ...
            <label for="<?php echo $this->get_field_id('dribbble'); ?>"><?php esc_html_e( 'Dribbble Url', 'dblogger' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('behance'); ?>"><?php esc_html_e( 'Behance Url', 'dblogger' ); ?></label><br/>
